...
int n = array.Length; //array.Length- количество элиментов массива
int find = 18;
int index = 0;
while (index < n)
{
    if (array[index] == find)
    {
        ...
        break;// при одинаковых цифрах массива, прирвет действие когда найдет первую искомую цифру
    }
    // index = index +1; можно так.
    index++; //но удобней так.
}